	...
	<div id="subpage" class="wrap">
		<div id="subpage_content">
			...
			<div class="the_content">
				<em class="archive_meta">by <?php the_author_meta ('user_firstname') ?> <?php the_author_meta ('user_lastname') ?> on <?php the_time ('M j, Y') ?> <?php if( function_exists('ADDTOANY_SHARE_SAVE_KIT') ) { ADDTOANY_SHARE_SAVE_KIT(); } ?></em>
				<h1 class="archives_heading"><?php the_title (); ?></h1>
